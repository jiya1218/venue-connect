...
const searches: { label: string; url: string }[] = [
  { label: "Wedding venues in Ahmedabad",           url: "/ahmedabad/wedding-venues" },
  { label: "Banquet halls in Surat",                url: "/surat/banquet-halls" },
  { label: "Farmhouses in Vadodara",                url: "/vadodara/farmhouses" },
  { label: "Birthday party venues in Rajkot",       url: "/rajkot/birthday-party-venues" },
  { label: "Corporate venues in Gandhinagar",        url: "/gandhinagar/corporate-event-venues" },
  { label: "Engagement venues in Ahmedabad",        url: "/ahmedabad/engagement-venues" },
  { label: "Pool party venues in Surat",            url: "/surat/pool-party-venues" },
  { label: "Garba venues in Vadodara",              url: "/vadodara/garba-venues" },
  { label: "Kitty party venues in Ahmedabad",       url: "/ahmedabad/kitty-party-venues" },
  { label: "Reception halls in Surat",              url: "/surat/reception-halls" },
  { label: "Party plots in Vadodara",               url: "/vadodara/party-plots" },
  { label: "Hotels for events in Rajkot",           url: "/rajkot/hotels" },
  { label: "Resorts in Gandhinagar",                url: "/gandhinagar/resorts" },
  { label: "Restaurant venues in Ahmedabad",        url: "/ahmedabad/restaurants" },
  { label: "Convention centers in Surat",           url: "/surat/convention-centers" },
